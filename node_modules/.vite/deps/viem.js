...
import {
  equalBytes,
  secp256k1
} from "./chunk-53CWG4Z4.js";
import "./chunk-EYWQEDDP.js";
...
async function getSocket(url_) {
  ...
  const { schedule } = createBatchScheduler({
    ...
    fn: async () => {
      var _a;
      let WebSocket = await import("./browser-4I3TWYBW.js");
...
async function recoverPublicKey({ hash, signature }) {
  ...
  if (v === 0 || v === 1)
    v += 27;
  const { secp256k1: secp256k12 } = await import("./secp256k1-RX6TKY6H.js");
...
function parseTransactionEIP1559(serializedTransaction) {
  const transactionArray = fromRlp(`0x${serializedTransaction.slice(4)}`, "hex");
